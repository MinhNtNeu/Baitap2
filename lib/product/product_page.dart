...
class ProductPage extends StatefulWidget {
  const ProductPage({Key? key, required this.result,required this.categoryId}) : super(key: key);
final int? result;
...
class ProductPageState extends State<ProductPage> {
  ...
  Future<CategoryIdModel> getCategoryIdModel() async {
      Response r = await dio.get(
          'https://mobile.gongu365.vn/v6/api/public/product/find-by-category-id?categoryId=${widget.categoryId}&page=0&size=10&sort=INSERT_DATETIME%2CDESC');
  ...
  Widget _productduceWidget() {
    ...
    return SizedBox(
        ...
        child: PageView.builder(
            ...
            itemBuilder: (ctx, idx) {
              print("Image URL: ${productImages[idx]}");
      ...
      width: 448.84,
      child: Center(
        child: Image.network(product.productImage ?? '', fit: BoxFit.fitHeight, height: 445,
          width: 448.84,),
      ),
    );
    }
              ...
              text: TextSpan(
                children: [
                  TextSpan(
                    ...
                    style: const TextStyle(fontSize: 10, color: Color(0xFFEA3636)),
                  ),
                  const TextSpan(
                    text: 'đã bán',
            ...
            Column(
              children: [
                ...
                const Padding(
                  ...
                  child: Text("Dự kiến thời gian giao hàng thực tế có thể khác nhau tùy thuộc vào hoàn"
          ...
          children: [
            Row(
              children: [
                ...
                Text(product.brand?.brandName ?? '', style: const TextStyle(color: Color(0xFF595D5F),fontWeight: FontWeight.w500,fontSize: 13),),
              ],
            ),
              ...
              Stack(
                children: [
                  ...
                  const Positioned(
                    right: 23,
                      top: 8,
                      child: Text('20K', style: TextStyle(color: Color(0xFF2E2E2E),fontWeight: FontWeight.w500,fontSize: 14),))
                ],
              )
            ],
          ),
      ...
      children: [
        Row(
          ...
          children: [
              ...
              const SizedBox(
                  width: 80,
                  child: _InforWidget(name: 'Review (15)',color: Color(0xFFF2F2F2),font: Color(0xFFA5A5A5),)),
          ],
        ),
      ...
      children: [
        ...
        Container(
          ...
          child: const Center(
            ...
            child: Text(' Chọn Sản Phẩm',style: TextStyle(color: Color(0xFFFFFFFF),fontWeight: FontWeight.w500,fontSize: 13), ),
          ),
        )
      ],
    );
